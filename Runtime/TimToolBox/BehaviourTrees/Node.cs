...
namespace BehaviourTrees {
    ...
    public class Sequence : Node {
        ...
        public override Status Process() {
            if (currentChild < children.Count) {
                if (lastProcessedChild != currentChild) {
                    children[currentChild].Start();
                    lastProcessedChild = currentChild;
                }
                switch (children[currentChild].Process()) {
                    case Status.Running:
                        return Status.Running;
    ...
    public class Leaf : Node {
        ...
        public override void Start() => strategy.Start();
    ...
    public class Node {
        ...
        protected int lastProcessedChild = -1;
    ...
    public class BehaviourTree : Node {
        ...
        public override Status Process() {
            ...
            if (status != Status.Running) {
                if (currentChild + 1 >= children.Count) //run all child once
                    Reset();
                else
